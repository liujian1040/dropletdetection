...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_path", type=str, default="./input", help="Path to Image Directory")
    parser.add_argument("--output_path", type=str, default="./output", help="Path to Image Directory")
