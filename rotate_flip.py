...
def label_flip(label_dict, flag, width):
...
def copy_json_label(input_dir, output_dir):
    for filename in os.listdir(input_dir):
        if filename.endswith('json'):
            ...
            new_dict = label_flip(load_dict, 1, width)  # 水平翻转
...
input_dir = r'C:/Users/Administrator/Desktop/CystalDetection-master/7'
output_dir = r'C:/Users/Administrator/Desktop/CystalDetection-master/8'
ext = '.png'
